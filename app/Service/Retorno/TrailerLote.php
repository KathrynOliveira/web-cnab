...
class TrailerLote
{
    ...
    public $qtdTitulosCobrancaSimples;
    public $valorTotalTitulosCobranca;
    public $qtdTitulosCobrancaVinculada;
    public $valorTotalTitulosCobrancaVinculada;
    public $qtdTitulosCobrancaCaucionada;
    public $valorTotalTitulosCobrancaCaucionada;
    public $qtdTitulosCobrancaDescontada;
    public $valorTotalTitulosCobrancaDescontada;
    public $numeroAvisoLancamento;
